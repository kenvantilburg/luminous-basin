...
#file_N_sig_lim = dir_res+'vols/N_sig_lim_'+str(i_p)+'_'+str(i_m)+'_'+str(k)+'.csv'
file_res = dir_res+'results_yellin_k'+str(k)+'.csv'
...
##### write out data #####
print('i_p = '+str(i_p)+', m = '+str(m)[0:8]+', N_sig_lim_yellin = '+str(N_sig_lim_yellin)[0:8])
df = pd.DataFrame(data = [[i_p, m, N_sig_lim_yellin]], columns=['i_p','m','N_sig_lim_yellin'])
with open(file_res,'a') as f: #open data file, in 'append mode'
